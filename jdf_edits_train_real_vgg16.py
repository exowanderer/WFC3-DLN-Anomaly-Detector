...
from VGGNet16.VGGNet16 import vgg_net_16
...
ap.add_argument("-m" , "--model"     , type=str  , required=False, help="path to output model"                             , default='rename_me_wfc3_realVGG_model'                      )
ap.add_argument("-l" , "--labelbin"  , type=str  , required=False, help="path to output label binarizer"                   , default='rename_me_lb'                                    )
ap.add_argument("-p" , "--plot"      , type=str  , required=False, help="path to output accuracy/loss plot"                , default="rename_me_wfc3_realVGG_model_loss_acc.png")
...
# args["model"]         = 'jdf_edits_2nd_test_wfc3_realVGG_model'
# args["labelbin"]      = 'jdf_edits_2nd_test_lb'
# args["plot"]          = 'jdf_edits_2nd_test_wfc3_realVGG_model_loss_acc.png'
...
tboard = TensorBoard(log_dir='./logs', histogram_freq=0, batch_size=32, write_graph=True, 
                     write_grads=False, write_images=False, embeddings_freq=0, 
                     embeddings_layer_names=None, embeddings_metadata=None, embeddings_data=None)

print("[INFO] compiling model...")
model = vgg_net_16.build(width=IMAGE_DIMS[1], height=IMAGE_DIMS[0],
